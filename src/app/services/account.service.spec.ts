...
describe('AccountService', () => {
    ...
    describe('Initialization', () => {
        it('should initialize with user from localStorage', () => {
            // Clear the current service and create a fresh instance
    ...
    describe('update()', () => {
        it('should update user when same ID is logged in', () => {
            ...
            service['userSubject'].next(userWithId1);
        ...
        it('should not update user if ID does not match current user', () => {
            ...
            expect(service.userValue?.id).toBe(originalUser?.id);
            expect(service.userValue?.lastName).toBe(originalUser?.lastName);
        });
    });
